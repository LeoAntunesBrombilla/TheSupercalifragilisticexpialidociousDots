...
-- local utils = require('nd-plugins.nd-utils')
local utils = require("nd-utils._general")
...
utils.define_augroups({
    _general_settings = {
		-- this will highlight text after yanking it
	...
	-- uncomment if for some reason lsp servers are not loading at startup
	-- _language_servers = {
	-- 	{'VimEnter', '*', 'LspStart'}
	-- },
    _buffer_bindings = {
