...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'indent-blankline.nvim', 'comfortable-motion.vim', 'AutoSave.nvim', 'todo-comments.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
