...
_G.packer_plugins = {
  ...
  ["DAPInstall.nvim"] = {
    config = { "\27LJ\1\2G\0\0\2\0\2\0\0044\0\0\0%\1\1\0>\0\2\1G\0\1\0,nvdope.initialization.debug.dap_install\frequire\0" },
    load_after = {
      ["nvim-dap"] = true
    },
    loaded = false,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'AutoSave.nvim', 'lspkind-nvim', 'nvim-toggleterm.lua', 'close-buffers.vim', 'lspsaga.nvim', 'nvim-colorizer.lua', 'editorconfig-vim', 'plenary.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
