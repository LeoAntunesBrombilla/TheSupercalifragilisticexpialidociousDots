...
_G.packer_plugins = {
  ...
  ["nvim-comment"] = {
    config = { "\27LJ\2\n>\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0#nd-plugins.nd-nvimcomment.init\frequire\0" },
    loaded = false,
    needs_bufread = false,
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'comfortable-motion.vim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au CursorMoved * ++once lua require("packer.load")({'nvim-autopairs', 'vim-visual-multi'}, { event = "CursorMoved *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lspconfig', 'indent-blankline.nvim', 'tagbar'}, { event = "BufRead *" }, _G.packer_plugins)]]
